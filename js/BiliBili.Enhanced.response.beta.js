...
*/
const $ = new Env("📺 BiliBili:Enhanced v1.0.1(3) response.beta");
const URL = new URLs();
const DataBase = {
	"Enhanced":{
		"Settings":{"Switch":"true","Home":{"Top_left":["我的Bottom"],"Top":["消息Top"],"Top_more":[],"Tab":["直播tab","推荐tab","hottopic","bangumi","anime","koreavtw"],"Default_Tab":"bangumi"},"Bottom":["home","dynamic","ogv","会员购Bottom","我的Bottom"]},
		"Configs":{
