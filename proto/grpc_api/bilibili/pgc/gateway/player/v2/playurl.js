...
class ClipInfo$Type extends MessageType {
    ...
    create(value) {
        const message = { materialNo: "0", start: 0, end: 0, clipType: 0, toastText: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class ContinuePlayInfo$Type extends MessageType {
    ...
    create(value) {
        const message = { continuePlayEpId: "0" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class Coupon$Type extends MessageType {
    ...
    create(value) {
        const message = { couponToken: "", type: "0", value: "", useDesc: "", title: "", desc: "", payButtonText: "", payButtonTextLineThrough: "", realAmount: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class DashItem$Type extends MessageType {
    ...
    create(value) {
        const message = { id: 0, baseUrl: "", backupUrl: [], bandwidth: 0, codecid: 0, md5: "", size: "0", frameRate: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class DashVideo$Type extends MessageType {
    ...
    create(value) {
        const message = { baseUrl: "", backupUrl: [], bandwidth: 0, codecid: 0, md5: "", size: "0", audioId: 0, noRexcode: false, frameRate: "", width: 0, height: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class Dialog$Type extends MessageType {
    ...
    create(value) {
        const message = { code: "0", msg: "", type: "", styleType: "", button: [], countDownSec: 0, bottomDisplay: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class MultiView$Type extends MessageType {
    ...
    create(value) {
        const message = { buttonMaterial: "", epId: "0", cid: "0", avid: "0" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class PayTip$Type extends MessageType {
    ...
    create(value) {
        const message = { title: "", url: "", icon: "", type: 0, showType: 0, img: "", bgDayColor: "", bgNightColor: "", bgLineColor: "", bgNightLineColor: "", textColor: "", textNightColor: "", viewStartTime: "0", button: [], urlOpenType: 0, angleStyle: 0, reportType: 0, orderReportParams: {} };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class StreamInfo$Type extends MessageType {
    ...
    create(value) {
        const message = { quality: 0, format: "", description: "", errCode: 0, needVip: false, needLogin: false, intact: false, noRexcode: false, attribute: "0", newDescription: "", displayDesc: "", superscript: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
